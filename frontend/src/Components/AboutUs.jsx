      ...
      <div className="max-w-4xl text-center">
        ...
        <div className="bg-gray-800/50 backdrop-blur-md p-8 md:p-12 rounded-2xl shadow-2xl border border-gray-700/50">
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light">
            <span className="text-3xl font-bold text-purple-400">"W</span>elcome to NeuroPalette, your ultimate AI-powered image enhancement suite. 
            ...
            to flawless user experience, NeuroPalette is redefining the boundaries of digital art and automated image processing.
